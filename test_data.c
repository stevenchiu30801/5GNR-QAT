/*
 * The test data sets are referred to the following documents:
 *
 * 1. ETSI/SAGE Specification of the 3GPP Confidentially and Integrity Algorithms UEA2 & UIA2.
 *    Document 3: Implementors' Test Data. Version: 1.1 Date: 25th October 2012.
 *    https://www.gsma.com/security/wp-content/uploads/2019/05/Doc3-UEA2-UIA2-Spec-Implementors-Test-Data.pdf
 *
 * 2. 3GPP TS33.401 V16.3.0 (2020-07).
 *    3GPP System Architecture Evolution (SAE); Security architecture (Release 16).
 *    https://www.3gpp.org/DynaReport/33401.htm
 *
 * 3. ETSI/SAGE Specification of the 3GPP Confidentiality and Integrity Algorithms 128-EEA3 & 128-EIA3.
 *    Document 3: Implementor’s Test Data. Version: 1.1 Data: 4th January 2011.
